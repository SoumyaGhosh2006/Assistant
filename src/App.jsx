...
import va from "./assets/ramlal.png"
...
function App(){
  ...
  const downloadImage = () => {
    if (generatedImage) {
      ...
      link.download = `ramlal-generated-image-${Date.now()}.png`;
  ...
  return(
    <div className="main">
      <img src={va} alt="" id="ramlal"></img>
      <span>I'm Ramlal, your personal assistant</span>
        ...
        <div className="response">
          ...
          {generatedImage && (
            <div className="generated-image-container">
              <img src={generatedImage} alt="Generated by Ramlal" className="generated-image" />
